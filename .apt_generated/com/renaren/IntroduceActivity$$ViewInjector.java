...
public class IntroduceActivity$$ViewInjector {
  public static void inject(Finder finder, final com.renaren.IntroduceActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131361812, "field 'LvMbti'");
    ...
    view = finder.findRequiredView(source, 2131361814, "field 'etNewCode'");
    target.etNewCode = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131361815, "field 'addCode'");

...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		share = (RelativeLayout) findViewById(R.id.shareApp);
		faceMaster = (RelativeLayout) findViewById(R.id.faceMaster);
		...
		faceMaster.setOnClickListener(listener);
	...
	OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.recommend:
				...
				break;
			case R.id.faceMaster:
				Intent intentFace = new Intent(getApplicationContext(), FaceMasterActivity.class);
			...
			case R.id.shareApp:
				...
				oks.setTitle("人啊人");
				oks.setTitleUrl("http://a.app.qq.com/o/simple.jsp?pkgname=com.renaren");
				oks.setUrl("http://a.app.qq.com/o/simple.jsp?pkgname=com.renaren");
				oks.setText("人啊人手机端正式上线啦！");
				oks.setImageUrl("http://www.renaren.com/themes/default/images/ico.png");
				oks.setSilent(false);
				oks.setDialogMode();
